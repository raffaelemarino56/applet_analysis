...
with open('../dati.csv') as csv_file:
    ...
    aggiunte_da_craetore = df.groupby("creatorName").sum().reset_index()
    ...
    fig3 = px.pie(preferenze_per_creatore, values="creatorName", names="addCount", title="Distribuzione per creatore")
    #fig3.show()
